	...
	<form name="frm" id="frm" method="post" enctype="multipart/form-data">
		...
		<c:if test="${dto!=null}">
			...
			<input type="text" name="currentPage" id="currentPage"
				value="${currentPage}" />
			<input type="text" name="ref" id="ref" value="${dto.ref}" />
			<input type="text" name="re_step" id="re_step"
				value="${dto.re_step}" />
			<input type="text" name="re_level" id="re_level"
				value="${dto.re_level}" />
		</c:if>
